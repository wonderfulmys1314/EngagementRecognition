...
def LSTM_model():
    ...
    fx = LSTM(units=256, dropout=0.2, recurrent_dropout=0.2, use_bias=True, return_sequences=True)(x)
    fx = BatchNormalization()(fx)
    bx = LSTM(units=256, dropout=0.2, recurrent_dropout=0.2, use_bias=True, return_sequences=True, go_backwards=True)(x)
...
model = LSTM_model()
model.compile(optimizer=RMSprop(lr=lr_start, rho=0.9, epsilon=1e-06, clipnorm=0, clipvalue=1),
